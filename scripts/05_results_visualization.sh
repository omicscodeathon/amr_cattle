...
##ls  $file
##rm -r ../metagenome_analysis_results/$name/anvio_data/
##echo "removed anvio_data for:" $name
##rm -r ../metagenome_analysis_results/$name/results/sqm2anvio
##rm -r ../metagenome_analysis_results/$name/anvio_results
##echo "Removing sqm2anvio on:" $name
#anvio_out="$file/anvio_data"
##echo $anvio_out
##mkdir -p $anvio_out
##echo "succesfully created the directory:" $anvio_out
