...
def header(output_file):
    with open(output_file, 'a') as o:
        o.write('Sample\tNumberOfInputReads\tSurvivingReads\tDropped\n')
    o.close()
